export const config = {
	mapTitle: 'map-fisheries-catches', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-fisheries-cathces-europe.vercel.app/', // The url provided when deploying the map on Vercel
